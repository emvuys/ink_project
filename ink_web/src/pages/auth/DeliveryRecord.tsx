...
const AuthDeliveryRecord = () => {
    ...
    fetch(`${API_BASE_URL}/retrieve/${proofId}`)
      ...
      .then(fetchedData => {
        setData({
          ...
          delivery_location: 'Gujarat, India',
          delivery_gps: fetchedData.delivery?.delivery_gps || { lat: 23.0225, lng: 72.5714 },
          photo_urls: fetchedData.enrollment?.photo_urls || ['', '', '', ''],
          nfc_tag_id: fetchedData.nfc_uid || 'TEST-H838JVDC6',
          signature: fetchedData.signature || '0xe018...4203',
          public_key: fetchedData.public_key || '0x7a9f...8b2c',
        });
        setLoading(false);
      })
      .catch(err => {
  ...
  // Function to truncate long strings (show first 6 and last 4 characters)
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FAF9F6]">
        <div className="text-center">
          ...
          <p className="font-serif text-xl">Loading your delivery record...</p>
        </div>
      </div>
    );
  }
