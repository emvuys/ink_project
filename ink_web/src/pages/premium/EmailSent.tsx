    ...
    <div className="h-[100dvh] bg-background relative">
      ...
      >
        <div className="text-center animate-fade-in">
          ...
          <p className="text-xs text-[#5a5a6e] mb-8">Thank you for choosing ink. Premium Shipping</p>
          <p className="text-[10px] uppercase tracking-[0.2em] text-[#9a9aae]" style={{ fontFamily: "Inter, sans-serif" }}>Email Sent</p>
        </div>
      </main>
      ...
      <div className="absolute bottom-24 left-0 right-0 text-center z-10 pointer-events-auto">
        <Button
          variant="outline"
          onClick={() => navigate(`/premium/delivery-record/${proofId || 'demo'}`)}
